...
Endpoint = ${ENDPOINT}
AllowedIPs = ${ALLOWED_IPS}" >"/etc/wireguard/clients/${SERVER_WG_NIC}-client-${CLIENT_NAME}.conf"
...
AllowedIPs = ${CLIENT_WG_IPV4}/32,${CLIENT_WG_IPV6}/128" >>"/etc/wireguard/${SERVER_WG_NIC}.conf"
	...
	echo -e "${GREEN}Your client config file is in /etc/wireguard/clients/${SERVER_WG_NIC}-client-${CLIENT_NAME}.conf${NC}"
}
